...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private boolean isPublicEndpoint(String uri) {
        return uri.startsWith("/v3/api-docs/") ||uri.startsWith("/auth/verify-code") || uri.startsWith("/auth/send-code") ||uri.startsWith("/swagger-ui/") || uri.equals("/") || uri.startsWith("/auth/") || uri.startsWith("/static/") || uri.startsWith("/css/") || uri.startsWith("/js/") || uri.equals("/health") || uri.equals("/health/db");
    }
